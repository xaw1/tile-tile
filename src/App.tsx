    ...
    <div className="min-h-screen pb-20">
      ...
      <main className="w-full mt-12 overflow-x-hidden">
        ...
        <div className="max-w-3xl mx-auto px-4 w-full">
          ...
          <footer className="mt-20 pt-8 border-t border-[var(--color-border)] text-sm text-[var(--color-text-dim)] flex flex-col md:flex-row items-center justify-between gap-4 pb-20">
            <div className="flex items-center gap-4">
              <span>Free & open — no API key required</span>
              <a 
                href="https://github.com/xaw1" 
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 opacity-50 hover:opacity-100 hover:text-[var(--color-text-bright)] transition-all"
