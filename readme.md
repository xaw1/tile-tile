...
- 18 material presets (_Grass, Brick, Fabric..._) and custom material input
- 2 prompt styles with ability to create new user-defined ones (e.g. _"Video game asset"_)
- Selection of output sizes (128x128, 256x256, 512x512, 1024x1024)
- Prompt refinement through Mistral Small
